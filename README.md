...
| 🐯**김주열** | 
| 부족한 실력에 많은 것을 배워가는 한달이었습니다. 첫 팀프로젝트라 내가 맡은 역할은 어떻게든 해내겠다는 집념으로 매일 밤을 보냈고 만든 결과물에 대한 팀원들의 칭찬과 피드백이 지친 몸을 다시 일으키는 계기가 되었습니다. 저에게 채찍과 당근을 주시고 너무 잘 리드해 주신 혜연님, 1부터 100까지 물어보면 1000까지 알려주려고 하신 현수님, 다재다능함으로 항상 든든한 서포터를 해주신 은하님 저희 팀원들 덕분에 좋은 기억들을 가지고 프로젝트를 마무리 한 것 같습니다! |
| 🤖**안현수** | 
| 첫 리액트 프로젝트여서 두려움이 있었으나 하나씩 만들어지는 기능을 보면서 프로젝트를 완성할 수 있겠다는 자신감을 얻었습니다. 조원 모두가 지향하는 바가 일치해서 과정이 순탄했던 것 같습니다. 즐거운 분위기 속에서 모든 팀원이 각자의 역할을 잘 수행하여 만족스러운 결과물이 생겼습니다. 부족한점도 많았고 실수도 많았지만 협업을 경험해보여 많은 것을 배워갑니다. 끝까지 함께 열심히 해준 팀원분들께 감사드립니다. |
| 🐶**김은하** | 
| 저와 잘 맞는 팀원분들을 만나서 운이 좋았습니다.팀원 분들 다들 잘 하시는 분야가 달라서 시너지가 많이 났던 것 같습니다. 주열님은 디자이너 친구분께 피그마를 배워와서 직접 이것저것 그려주려 주셨고, 깃 브랜치 전략이나 폴더 구조등 큰 틀을 만드는 부분에 있어서 ‘제가 해보겠습니다’하고 만들어내시고 버그도 현수님 손에 들어가면 다 해결이 되곤 했습니다. 혜연님은 제가 문서화의 중요성을 잘 못느끼고 있었는데 혜연님이 정리해 놓은 wiki 등을 통해서 효율적으로 일 할 수 있는 부분이 있었습니다. 좋은 분들과 협업할 수 있는 기회를 만들어주셔서 정말 감사드리고, 개발하면서 여러 문제들을 해결하고 그 과정에서 리액트 문법에 익숙해지고 더 나은 코드를 위한 고민들을 경험할 수 있었습니다. 같이 달려서 원하는 목표를 성취하는 기쁨을 좋아하는데 CAMPERZ 프로젝트는 좋은 기회였습니다. 감사합니다. |
