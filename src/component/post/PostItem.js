...
export default function PostItem({
	...
	return (
		<>
			<S_ItemWrapper>
				<S_PostItemHeader>
					<S_ProfileImg onClick={handleAuthorClick} onError={handleImgError} src={author.image} alt="프로필 사진" />
				...
				<S_ContentBox>
					...
					<S_ImgBox>{image && <S_Img src={image} alt="" onError={handleImgError} />}</S_ImgBox>
					<S_SnsDate>
						<S_Sns>
